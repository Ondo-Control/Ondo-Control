# ONDO CONTROL — STAND
*Die aktuelle Wahrheit. Stand: 19.9.2026, Fassung 142, v19.18.2*
...
**Vermerk (19.9.2026, Ondo, Nachtrag zur Grundsatznachricht):** Blueprint 2d Punkt 4 nannte bis dahin noch den GitHub-Pages-Weg als ChatGPTs einzigen Zugriffsweg — im Widerspruch zu diesem Vermerk vom 28.8.2026, der bereits korrekt den direkten Repo-Zugriff festhielt. Im Blueprint berichtigt, hier nicht wiederholt (Punkt 45). Im selben Zug wurde Arbeitsregel K gelockert: ein frischer Prüfer-Chat ist nur noch nötig, wenn ein Prüfer seine eigene frühere Antwort oder eine überwiegend eigene Vorlage prüft — voller Wortlaut Blueprint, Abschnitt 2c.
