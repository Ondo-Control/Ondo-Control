...
*Diese Eintraege standen bis zum 14.9.2026 als „Beta zuvor:"-Zeilen in `STAND.md`, Abschnitt „Versionen". Wortgleich hierher verschoben, nichts geloescht oder umformuliert (Regel 3 des Backlogs, sinngemaess auch hier angewandt). Reihenfolge unveraendert (neueste zuerst) uebernommen, Umfang: 7.8.2026 bis 30.8.2026.*
